...
public class EmployerActivity extends AppCompatActivity {
    ...
    private void updateInDB(){
        ...
        String filter = SampleDBContract.Employer.COLUMN_NAME + "='" + name + "'";
        database.update(SampleDBContract.Employer.TABLE_NAME,values ,filter,null);
        Toast.makeText(this, "Employer: " + name + "'s records were updated.", Toast.LENGTH_LONG).show();

    }


    //delete existign employer in database
    private void deleteFromDB(){
        //connect to database
        SQLiteDatabase database = new SampleDBSQLiteHelper(this).getReadableDatabase();
        //Get first name of employee
        String name = binding.nameEditText.getText().toString();
        //call delete function in database to delete row where column first name has value "firstname"
        database.delete(SampleDBContract.Employer.TABLE_NAME, SampleDBContract.Employer.COLUMN_NAME + "='" + name + "'",null);
        // Success output
        Toast.makeText(this, "Employer: " + name + "was deleted", Toast.LENGTH_LONG).show();
    }
}
